...
right = Actor("right")
right.pos = CENTRE_X + 60, CENTRE_Y + 110
...
def draw():
    ...
    if not game_over:
        ...
        screen.clear()
        screen.bilt("stage", (0, 0))
        screen.draw.text("Score: " + str(score), color="black", topleft=(10, 10))
        screen.draw.text("GAME OVER! " , color="black", topleft=(CENTRE_X - 130, 220), fontsize=10)``   
    return
...
generate_moves()
pg.music.play("vanishing-horizon")
